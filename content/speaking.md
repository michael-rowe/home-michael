...
Where universities have historically controlled access to the expertise that many careers require, AI democratises it: anyone can learn from a personalised disciplinary expert, teacher, or mentor. New approaches will emerge around AI-assistance, project-based learning, and authentic assessment, and universities will lose their monopoly on accredited learning as cheaper alternatives appear.

The response, I suggest, is to raise our expectations for what education can be now that learners can partner with capable AI. Rather than using it to write better essays, learners can build businesses, community projects, marketing campaigns, and products. Formal professional education may soon look very different in a world where expertise is abundantly available to everyone.
