...
> [!info] Boyer widened what counts as scholarship, and rewards have lagged behind
> Academic debate often sets teaching against research, as if staff had to choose between them. Boyer (1990) showed that scholarship takes several forms that all call for rigour, so the useful question is which forms serve your context and how your institution values them.
...
**Scholarship of application** applies disciplinary expertise to consequential problems beyond the academy, with results that can be shared and evaluated by peers. What separates it from service is method: it brings scholarly methods to real-world problems and produces knowledge that advances both practice and theory.

**Scholarship of teaching**, now usually called the scholarship of teaching and learning, involves systematic study of teaching and learning processes. It covers inquiry into how learning happens, which pedagogies work in which contexts, and how students develop expertise. This legitimises educational scholarship as research rather than relegating it to service.

The line between good teaching and the scholarship of teaching is the one health professions educators most often find hard to draw. A pharmacy lecturer who redesigns a simulated dispensing session, and sees students make fewer errors, is teaching well. When they frame the redesign as a question, gather evidence on whether it worked, and publish it where other educators can critique and build on it, the same work becomes scholarship. That is the test Lee Shulman proposed for separating the two: the work has to be public, open to peer review, and something others can build on (Glassick, 2000).
...
In practice, that means reward systems that reflect this diversity, ways besides publication counts to evaluate scholarly performance, and an acceptance that the balance among the four forms will rightly differ by discipline, type of institution, and career stage.
