...
**One-sentence definition:** A diagnostic framework mapping [[large language models|LLM]] technical concepts (e.g. [[Notes/context window|context windows]], tokenisation, temperature, training data, and [[Notes/hallucination|hallucination]]) onto corresponding features of human cognitive architecture to reveal structural similarities in how both systems process information and exhibit limitations.
