...
> [!info] A curriculum knowledge graph that makes programme data queryable — and keeps you audit-ready.
...
- Product page: [Vertex — curriculum intelligence platform](https://education.snapplify.com/vertex-product-page/)
- Related: [[Essays/documentation-as-infrastructure|Documentation becomes infrastructure when AI agents are the readers]]
